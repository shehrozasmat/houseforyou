        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-md-4 mb-4">
              <div className="text-center testimonial-card">
                <div className="rounded-circle mx-auto mb-3 gallery-image-hover" style={{
                  backgroundImage: `url('/Zbyszek.png')`,
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  width: '128px',
                  height: '128px'
            ...
            <div className="col-md-4 mb-4">
              <div className="text-center testimonial-card">
                <div className="rounded-circle mx-auto mb-3 gallery-image-hover" style={{
                  backgroundImage: `url('/michal (1) 1.png')`,
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  width: '128px',
                  height: '128px'
      ...
      <section className="py-5 bg-white">
        <div className="container">
          ...
          <div className="row mb-5">
            <div className="col-md-4 mb-4">
              <div className="rounded gallery-image-hover" style={{
                backgroundImage: `url('/strzeniówka51 1.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '300px'
              }}></div>
            ...
            <div className="col-md-4 mb-4">
              <div className="rounded gallery-image-hover" style={{
                backgroundImage: `url('/thumb2 1.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '300px'
              }}></div>
            ...
            <div className="col-md-4 mb-4">
              <div className="rounded gallery-image-hover" style={{
                backgroundImage: `url('/ursus 1.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '300px'
              }}></div>
          ...
          <div className="row g-1">
            <div className="col-2">
              <div className="rounded" style={{
                backgroundImage: `url('/Rectangle 57.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '258px'
              }}></div>
            ...
            <div className="col-2">
              <div className="rounded" style={{
                backgroundImage: `url('/Rectangle 58.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '258px'
              }}></div>
            ...
            <div className="col-2">
              <div className="rounded" style={{
                backgroundImage: `url('/Rectangle 59.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '258px'
              }}></div>
            ...
            <div className="col-2">
              <div className="rounded" style={{
                backgroundImage: `url('/Rectangle 60.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '258px'
              }}></div>
            ...
            <div className="col-2">
              <div className="rounded" style={{
                backgroundImage: `url('/Rectangle 61.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '258px'
              }}></div>
            ...
            <div className="col-2">
              <div className="rounded" style={{
                backgroundImage: `url('/Rectangle 62.png')`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                height: '258px'
              }}></div>
